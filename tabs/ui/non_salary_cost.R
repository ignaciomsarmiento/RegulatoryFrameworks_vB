                    ...
                    tags$div(
                      ...
                      tags$div(
                        ...
                        tags$div(
                          ...
                          tags$p("TOTAL = overall non-wage cost.", style = "font-size: 12px; color: #555; margin: 0;"),
                        ...
                        tags$div(
                          style = "display: flex; flex-direction: column; gap: 4px;",
                          tags$p("BY PAYER = split between employer and worker.", style = "font-size: 12px; color: #555; margin: 0;"),
                        ...
                        tags$div(
                          style = "display: flex; flex-direction: column; gap: 4px;",
                          tags$p("BY COMPONENT = itemized mandatory benefits (each line).", style = "font-size: 12px; color: #555; margin: 0;"),
